...
CMakeFiles/bootloader-complete: bootloader-prefix/src/bootloader-stamp/bootloader-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'bootloader'"
	/usr/bin/cmake -E make_directory /home/jona/esp-idf/Projects/blink-led/build/CMakeFiles
	/usr/bin/cmake -E touch /home/jona/esp-idf/Projects/blink-led/build/CMakeFiles/bootloader-complete
	/usr/bin/cmake -E touch /home/jona/esp-idf/Projects/blink-led/build/bootloader-prefix/src/bootloader-stamp/bootloader-done
...
bootloader-prefix/src/bootloader-stamp/bootloader-build: bootloader-prefix/src/bootloader-stamp/bootloader-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Performing build step for 'bootloader'"
	cd /home/jona/esp-idf/Projects/blink-led/build/bootloader && $(MAKE)
...
bootloader-prefix/src/bootloader-stamp/bootloader-configure: bootloader-prefix/src/bootloader-stamp/bootloader-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Performing configure step for 'bootloader'"
	cd /home/jona/esp-idf/Projects/blink-led/build/bootloader && /usr/bin/cmake -DSDKCONFIG=/home/jona/esp-idf/Projects/blink-led/sdkconfig -DIDF_PATH=/home/jona/esp-idf -DIDF_TARGET=esp32 -DPYTHON_DEPS_CHECKED=1 -DPYTHON=/home/jona/.espressif/python_env/idf6.1_py3.14_env/bin/python -DEXTRA_COMPONENT_DIRS=/home/jona/esp-idf/components/bootloader -DPROJECT_SOURCE_DIR=/home/jona/esp-idf/Projects/blink-led -DIGNORE_EXTRA_COMPONENT= "-GUnix Makefiles" -S /home/jona/esp-idf/components/bootloader/subproject -B /home/jona/esp-idf/Projects/blink-led/build/bootloader
	cd /home/jona/esp-idf/Projects/blink-led/build/bootloader && /usr/bin/cmake -E touch /home/jona/esp-idf/Projects/blink-led/build/bootloader-prefix/src/bootloader-stamp/bootloader-configure
...
bootloader-prefix/src/bootloader-stamp/bootloader-download: bootloader-prefix/src/bootloader-stamp/bootloader-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "No download step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/jona/esp-idf/Projects/blink-led/build/bootloader-prefix/src/bootloader-stamp/bootloader-download

bootloader-prefix/src/bootloader-stamp/bootloader-install: bootloader-prefix/src/bootloader-stamp/bootloader-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'bootloader'"
	cd /home/jona/esp-idf/Projects/blink-led/build/bootloader && /usr/bin/cmake -E echo_append

bootloader-prefix/src/bootloader-stamp/bootloader-build:
.PHONY : bootloader-prefix/src/bootloader-stamp/bootloader-build

bootloader-prefix/src/bootloader-stamp/bootloader-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'bootloader'"
	/usr/bin/cmake -Dcfgdir= -P /home/jona/esp-idf/Projects/blink-led/build/bootloader-prefix/tmp/bootloader-mkdirs.cmake
	/usr/bin/cmake -E touch /home/jona/esp-idf/Projects/blink-led/build/bootloader-prefix/src/bootloader-stamp/bootloader-mkdir
...
bootloader-prefix/src/bootloader-stamp/bootloader-patch: bootloader-prefix/src/bootloader-stamp/bootloader-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/jona/esp-idf/Projects/blink-led/build/bootloader-prefix/src/bootloader-stamp/bootloader-patch
...
bootloader-prefix/src/bootloader-stamp/bootloader-update: bootloader-prefix/src/bootloader-stamp/bootloader-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/jona/esp-idf/Projects/blink-led/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No update step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/jona/esp-idf/Projects/blink-led/build/bootloader-prefix/src/bootloader-stamp/bootloader-update
